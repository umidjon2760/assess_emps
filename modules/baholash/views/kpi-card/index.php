...
for ($i=1; $i < 13; $i++) { 
    if($act_class==$i){
        $bred.="<a href='?r=baholash/kpi-card/index&bfdo1NGa1JkjfMn78t82dM17V=".$bfdo1NGa1JkjfMn78t82dM17V."&oe63p0LOioXr16zlQ2IOSf2cr=fqsqsdd&oy=".$i."' class='btnpr kl'>".Period::getMonthName($i)."</a>";  
    }   
    else{
        $bred.="<a href='?r=baholash/kpi-card/index&bfdo1NGa1JkjfMn78t82dM17V=".$bfdo1NGa1JkjfMn78t82dM17V."&oe63p0LOioXr16zlQ2IOSf2cr=fqsqsdd&oy=".$i."' class='kl'>".Period::getMonthName($i)."</a>";
    }
}
