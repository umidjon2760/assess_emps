...
<div class="zagr-index card">
    <div class="card-body">
        ...
        <div id="divajax">
          ...
          echo "<tr>";
          echo "<td colspan='7'><b>".date('d.m.Y',strtotime(Period::getPeriod()))."</b></td>";
          echo "</tr>";
          foreach ($groups as $group_code => $group_name) {
              $facts = Fact::find()->where(['LOV_ID'=>Yii::$app->user->ID])->andWhere(['GROUP_CODE'=>$group_code])->andWhere(['PERIOD'=>Period::getPeriod()])->all();
              if ($facts) {
                echo "<tr>";
              ...
              foreach ($facts as $fact) {
                  ...
                  echo "<td style='width:20%;'>".Zagr::getBolimname($fact->NUV_ID)."</td>";
                  echo "<td style='width:10%;'>".Zagr::getDoljName($fact->NUV_ID)."</td>";
...
<script type="text/javascript">
  ...
  {
    $.ajax({
        url: "?r=baholash/zagr/get-enter-baholar",
        type: "POST",
        data: ({ 
          id: $("#met").val(),
