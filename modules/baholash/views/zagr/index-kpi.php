        ...
        'columns' => [
            ...
            [
                ...
                'value'=>function($data){
                    ...
                    // print_r($data);
                    // echo "</pre>";die;
                    $avg = Fact::getAvgValue($data->INPS,Period::getPeriod(),'only_kpi').'%';
                     Modal::begin([
                    ...
                    return Html::button(
                                       $avg, [
                                            ...
                                            'onclick'=>'modal('.$data->INPS.',"only_kpi")',
                                        ]
                                    );
            ...
            [
                ...
                'contentOptions' => function ($data) {
                    return  Fact::getClass($data->INPS,'only_kpi');
                },

                'value' => function ($data) {
                        return Fact::getLink($data->INPS,'only_kpi');
...
echo "</p>";
    ...
    $this->title = 'Сессия на текущий период еще не открыта администратором системы.';
?>
