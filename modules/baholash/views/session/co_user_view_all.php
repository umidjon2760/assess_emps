...
$this->title = 'Филиал бахолаш (360)';
$act_class = date('n',strtotime($period));
$bred='';
$bred.="<a href='?r=site/index'>Асосий</a>&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;";
for ($i=1; $i < 13; $i++) { 
    if($act_class==$i){
        $bred.="<a style='margin-left:5px;' href='?r=baholash/session/filial-baho-all&oy=".$i."' class=' btnpr'>".Period::getMonthName($i)."</a>&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;";  
    } 
    elseif ($i==date('n',strtotime(Period::getPeriod()))) {
        ...
        $bred.="<a  href='?r=baholash/session/filial-baho-all&oy=".$i."'>".Period::getMonthName($i)."</a>&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;";
    }
