...
<div class="card-body">
    ...
    ?>
    <p>
        <?= Html::a('Огохлантириш', ['zagr/send-message-for-session','BuBIU78rvu7CF876cvd8ws7nvgdsa'=>'only_360'], ['class' => 'btn btn-warning']) ?>
        <?= Html::a('Янги сессия очиш', ['openalltoone','group'=>'only_360'], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Бахолашни очиш', ['backalltosessionnokpifact','session_id'=>'1','group'=>'only_360'], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Бахолашни ёпиш', ['backalltosessionnokpifact','session_id'=>'2','group'=>'only_360'], ['class' => 'btn btn-danger']) ?>
...
foreach ($rows as $key) {
    ...
    <tr>
        ...
        <td>".$key['NAME']."</td>
        <td class='".Session::getclassForFilial(Session::getSessionForFilial($key['LOCAL_CODE'],'only_360'))."'>".Session::getSessionForFilial($key['LOCAL_CODE'],'only_360')."</td>
        <td><a href='?r=baholash/session/fil-view&code=".$key['LOCAL_CODE']."&group=only_360'>Кўриш</a></td>
    </tr>";
    $i++;
}
?>
